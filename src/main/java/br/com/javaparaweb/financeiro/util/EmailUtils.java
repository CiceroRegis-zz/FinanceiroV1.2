...
public class EmailUtils {
	 ...
	 */
	EmailUtils(String mailSMTPServer, String mailSMTPServerPort) { //Para outro Servidor
	...
	public void sendMail(Usuario usuario) {
		...
		props.put("mail.smtp.user", "testejava2018@gmail.com"); //usuario ou seja, a conta que esta enviando o email (tem que ser do GMAIL)
		...
		auth = new SimpleAuth ("testejava2018@gmail.com","Meups32014");
		...
		try {
			...
			msg.setFrom(new InternetAddress("testejava2018@gmail.com"));
			//Setando o assunto
			msg.setSubject("cadastro");
			//Setando o conteúdo/corpo do email
			msg.setContent("cadastro realizado com sucesso",null);
		} catch (Exception e) {
		...
		try {
			 ...
			 */
			tr.connect(mailSMTPServer, "testejava2018@gmail.com", "Meups32014");
